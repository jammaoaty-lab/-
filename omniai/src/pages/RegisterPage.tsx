        ...
        <div className="flex flex-col justify-center px-8 pb-12">
          ...
          >
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className={`w-full h-11 pl-10 pr-4 rounded-xl bg-surface-secondary border text-sm text-text-primary placeholder:text-text-tertiary focus:outline-none focus:ring-2 transition-all ${
                      isEmailInvalid
                        ? 'border-danger focus:border-danger/40 focus:ring-danger/10'
                        : 'border-border-light focus:border-primary/40 focus:ring-primary/10'
                    }`}
                  />
                </div>
                {isEmailInvalid && (
                  <span className="text-[11px] mt-1 block text-danger">请输入有效的邮箱地址</span>
                )}
              </div>
            ...
            <div className="mt-6 flex items-center gap-3">
              ...
              <span className="text-[11px] text-text-tertiary">其他方式注册</span>
              <div className="flex-1 h-px bg-border-light" />
            </div>

            <div className="mt-4 flex items-center justify-center gap-5">
              <button onClick={() => showToast('QQ注册功能即将上线', 'info')} className="flex flex-col items-center gap-1.5 group">
              ...
              <button onClick={() => showToast('微信注册功能即将上线', 'info')} className="flex flex-col items-center gap-1.5 group">
              ...
              <button onClick={() => showToast('抖音注册功能即将上线', 'info')} className="flex flex-col items-center gap-1.5 group">
              ...
              <button onClick={() => showToast('Google注册功能即将上线', 'info')} className="flex flex-col items-center gap-1.5 group">
